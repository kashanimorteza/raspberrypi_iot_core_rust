...
use axum::Router;
use crate::AppState;
use crate::api::handlers::port::{list_ports, get_port, create_port, update_port, delete_port, disable_port, enable_port, status_port};
...
pub fn router() -> Router<AppState> 
{
    Router::new()
        ...
        .route("/status/{id}", get(status_port))
