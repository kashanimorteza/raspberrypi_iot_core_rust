...
use axum::Router;
use crate::AppState;
use crate::api::handlers::device_command::{list_device_commands, get_device_command, create_device_command, update_device_command, delete_device_command, disable_device_command, enable_device_command};
