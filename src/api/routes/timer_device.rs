...
use axum::Router;
use crate::AppState;
use crate::api::handlers::timer_device::{list_timer_devices, get_timer_device, create_timer_device, update_timer_device, delete_timer_device, disable_timer_device, enable_timer_device, status_timer_device};
